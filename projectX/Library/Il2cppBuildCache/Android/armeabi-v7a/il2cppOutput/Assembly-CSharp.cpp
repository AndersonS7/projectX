...
{
	{
		...
		__this->set_radius_6(((float)((float)L_3/(float)(2.0f))));
		// panelGameOver.SetActive(false);
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_4 = __this->get_panelGameOver_4();
		NullCheck(L_4);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DetectColider_Detect_m3D53E3420B41D85899AB4A74618285E677594CBB (DetectColider_t5175106E96CE21174E46BE33CB290F817E4715ED * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_8 = __this->get_panelGameOver_4();
		NullCheck(L_8);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FuelCollider_OnTriggerEnter2D_mDFD7F47ABE15538DCEF5F17D5629188252637197 (FuelCollider_tE8C9954D1E487A32032B366F438408E60709854A * __this, Collider2D_tDDBF081328B83D21D0BA3B5036D77B32528BA722 * ___collision0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		int32_t L_2;
		L_2 = Random_Range_m4B3A0037ACA057F33C94508F908546B9317D996A(5, ((int32_t)10), /*hidden argument*/NULL);
		V_0 = L_2;
		// player.AddFuel(fuel);
		Player_t5689617909B48F7640EA0892D85C92C13CC22C6F * L_3 = __this->get_player_4();
		int32_t L_4 = V_0;
		NullCheck(L_3);
		Player_AddFuel_m9A2F8E5C92182739E131243D0C4E73A9E1839D87(L_3, L_4, /*hidden argument*/NULL);
		// Destroy(gameObject);
...
IL_002d:
	{
		...
		NullCheck(L_6);
		bool L_7;
		L_7 = Component_CompareTag_m17D74EDCC81A10B18A0A588519F522E8DF1D7879(L_6, _stringLiteralAB236FE2BF72D00A5CFAFFB9CA58750A49DA02B2, /*hidden argument*/NULL);
		if (!L_7)
		{
			goto IL_0045;
		}
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void MenuControl::Restart()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MenuControl_Restart_m9A3AC0DC7756B06913563D2F1A0885C6C68EB0BA (MenuControl_tD6B61EA950F8DF6E5A76C458AAA2E71D25654778 * __this, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_004d:
	{
		// currentFuel = totalFuel;
		float L_12 = __this->get_totalFuel_10();
		__this->set_currentFuel_12(L_12);
		// }
		return;
	}
}
...
{
	{
		...
		float L_2 = __this->get_timeCount_7();
		float L_3 = __this->get_timeCountLimit_6();
		if ((!(((float)L_2) >= ((float)L_3))))
		{
			goto IL_0038;
		}
